...
func Test_Reconcile(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "dnsNameResolver feature enabled",
			existingObjects: []runtime.Object{
			...
			expectCreate: []client.Object{
				crd("dnsnameresolvers.network.openshift.io"),
			},
			expectUpdate:    []client.Object{},
			expectDelete:    []client.Object{},
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			cmpOpts := []cmp.Option{
				cmpopts.EquateEmpty(),
				cmpopts.IgnoreFields(metav1.ObjectMeta{}, "ResourceVersion", "Annotations"),
...
func TestReconcileOnlyStartsControllerOnce(t *testing.T) {
	...
	req := reconcile.Request{NamespacedName: types.NamespacedName{Name: "dnsnameresolvers.network.openshift.io"}}
...
func (c *fakeController) Reconcile(context.Context, reconcile.Request) (reconcile.Result, error) {
	return reconcile.Result{}, nil
}

func (c *fakeController) Watch(_ source.Source, _ handler.EventHandler, _ ...predicate.Predicate) error {
	return nil
}
